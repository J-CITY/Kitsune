...
BASS_ASIO_GetVersion = func_type(ctypes.c_ulong)(('BASS_ASIO_GetVersion', bassasio_module))
#DWORD BASSASIODEF(BASS_ASIO_ErrorGetCode)();
BASS_ASIO_ErrorGetCode = func_type(ctypes.c_ulong)(('BASS_ASIO_ErrorGetCode', bassasio_module))
#BOOL BASSASIODEF(BASS_ASIO_GetDeviceInfo)(DWORD device, BASS_ASIO_DEVICEINFO *info);
BASS_ASIO_GetDeviceInfo = func_type(ctypes.c_byte, ctypes.c_ulong, ctypes.POINTER(BASS_ASIO_DEVICEINFO))(('BASS_ASIO_GetDeviceInfo', bassasio_module))
#BOOL BASSASIODEF(BASS_ASIO_SetDevice)(DWORD device);
BASS_ASIO_SetDevice = func_type(ctypes.c_byte, ctypes.c_ulong)(('BASS_ASIO_SetDevice', bassasio_module))
#DWORD BASSASIODEF(BASS_ASIO_GetDevice)();
BASS_ASIO_GetDevice = func_type(ctypes.c_ulong)(('BASS_ASIO_GetDevice', bassasio_module))
#BOOL BASSASIODEF(BASS_ASIO_Init)(DWORD device);
BASS_ASIO_Init = func_type(ctypes.c_byte, ctypes.c_ulong)(('BASS_ASIO_Init', bassasio_module))
#BOOL BASSASIODEF(BASS_ASIO_Free)();
BASS_ASIO_Free = func_type(ctypes.c_byte)(('BASS_ASIO_Free', bassasio_module))
#BOOL BASSASIODEF(BASS_ASIO_SetNotify)(ASIONOTIFYPROC *proc, void *user);
BASS_ASIO_SetNotify = func_type(ctypes.c_byte, ASIONOTIFYPROC, ctypes.c_void_p)(('BASS_ASIO_SetNotify', bassasio_module))
#BOOL BASSASIODEF(BASS_ASIO_ControlPanel)();
BASS_ASIO_ControlPanel = func_type(ctypes.c_byte)(('BASS_ASIO_ControlPanel', bassasio_module))
#BOOL BASSASIODEF(BASS_ASIO_GetInfo)(BASS_ASIO_INFO *info);
BASS_ASIO_GetInfo = func_type(ctypes.c_byte, ctypes.POINTER(BASS_ASIO_INFO))(('BASS_ASIO_GetInfo', bassasio_module))
#BOOL BASSASIODEF(BASS_ASIO_SetRate)(double rate);
BASS_ASIO_SetRate = func_type(ctypes.c_byte, ctypes.c_double)(('BASS_ASIO_SetRate', bassasio_module))
#double BASSASIODEF(BASS_ASIO_GetRate)();
BASS_ASIO_GetRate = func_type(ctypes.c_double)(('BASS_ASIO_GetRate', bassasio_module))
#BOOL BASSASIODEF(BASS_ASIO_Start)(DWORD buflen);
BASS_ASIO_Start = func_type(ctypes.c_byte, ctypes.c_ulong)(('BASS_ASIO_Start', bassasio_module))
#BOOL BASSASIODEF(BASS_ASIO_Stop)();
BASS_ASIO_Stop = func_type(ctypes.c_byte)(('BASS_ASIO_Stop', bassasio_module))
#BOOL BASSASIODEF(BASS_ASIO_IsStarted)();
BASS_ASIO_IsStarted = func_type(ctypes.c_byte)(('BASS_ASIO_IsStarted', bassasio_module))
#DWORD BASSASIODEF(BASS_ASIO_GetLatency)(BOOL input);
BASS_ASIO_GetLatency = func_type(ctypes.c_ulong, ctypes.c_byte)(('BASS_ASIO_GetLatency', bassasio_module))
#float BASSASIODEF(BASS_ASIO_GetCPU)();
BASS_ASIO_GetCPU = func_type(ctypes.c_float)(('BASS_ASIO_GetCPU', bassasio_module))
#BOOL BASSASIODEF(BASS_ASIO_Monitor)(int input, DWORD output, DWORD gain, DWORD state, DWORD pan);
BASS_ASIO_Monitor = func_type(ctypes.c_byte, ctypes.c_int, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_ulong)(('BASS_ASIO_Monitor', bassasio_module))

#BOOL BASSASIODEF(BASS_ASIO_ChannelGetInfo)(BOOL input, DWORD channel, BASS_ASIO_CHANNELINFO *info);
BASS_ASIO_ChannelGetInfo = func_type(ctypes.c_byte, ctypes.c_byte, ctypes.c_ulong, ctypes.POINTER(BASS_ASIO_CHANNELINFO))(('BASS_ASIO_ChannelGetInfo', bassasio_module))
#BOOL BASSASIODEF(BASS_ASIO_ChannelReset)(BOOL input, int channel, DWORD flags);
BASS_ASIO_ChannelReset = func_type(ctypes.c_byte, ctypes.c_byte, ctypes.c_int, ctypes.c_ulong)(('BASS_ASIO_ChannelReset', bassasio_module))
#BOOL BASSASIODEF(BASS_ASIO_ChannelEnable)(BOOL input, DWORD channel, ASIOPROC *proc, void *user);
BASS_ASIO_ChannelEnable = func_type(ctypes.c_byte, ctypes.c_byte, ctypes.c_ulong, ASIOPROC, ctypes.c_void_p)(('BASS_ASIO_ChannelEnable', bassasio_module))
#BOOL BASSASIODEF(BASS_ASIO_ChannelEnableMirror)(DWORD channel, BOOL input2, DWORD channel2);
BASS_ASIO_ChannelEnableMirror = func_type(ctypes.c_byte, ctypes.c_ulong, ctypes.c_byte, ctypes.c_ulong)(('BASS_ASIO_ChannelEnableMirror', bassasio_module))
#BOOL BASSASIODEF(BASS_ASIO_ChannelJoin)(BOOL input, DWORD channel, int channel2);
BASS_ASIO_ChannelJoin = func_type(ctypes.c_byte, ctypes.c_byte, ctypes.c_ulong, ctypes.c_int)(('BASS_ASIO_ChannelJoin', bassasio_module))
#BOOL BASSASIODEF(BASS_ASIO_ChannelPause)(BOOL input, DWORD channel);
BASS_ASIO_ChannelPause = func_type(ctypes.c_byte, ctypes.c_byte, ctypes.c_ulong)(('BASS_ASIO_ChannelPause', bassasio_module))
#DWORD BASSASIODEF(BASS_ASIO_ChannelIsActive)(BOOL input, DWORD channel);
BASS_ASIO_ChannelIsActive = func_type(ctypes.c_ulong, ctypes.c_byte, ctypes.c_ulong)(('BASS_ASIO_ChannelIsActive', bassasio_module))
#BOOL BASSASIODEF(BASS_ASIO_ChannelSetFormat)(BOOL input, DWORD channel, DWORD format);
BASS_ASIO_ChannelSetFormat = func_type(ctypes.c_byte, ctypes.c_byte, ctypes.c_ulong, ctypes.c_ulong)(('BASS_ASIO_ChannelSetFormat', bassasio_module))
#DWORD BASSASIODEF(BASS_ASIO_ChannelGetFormat)(BOOL input, DWORD channel);
BASS_ASIO_ChannelGetFormat = func_type(ctypes.c_ulong, ctypes.c_byte, ctypes.c_ulong)(('BASS_ASIO_ChannelGetFormat', bassasio_module))
#BOOL BASSASIODEF(BASS_ASIO_ChannelSetRate)(BOOL input, DWORD channel, double rate);
BASS_ASIO_ChannelSetRate = func_type(ctypes.c_byte, ctypes.c_byte, ctypes.c_ulong, ctypes.c_double)(('BASS_ASIO_ChannelSetRate', bassasio_module))
#double BASSASIODEF(BASS_ASIO_ChannelGetRate)(BOOL input, DWORD channel);
BASS_ASIO_ChannelGetRate = func_type(ctypes.c_double, ctypes.c_byte, ctypes.c_ulong)(('BASS_ASIO_ChannelGetRate', bassasio_module))
#BOOL BASSASIODEF(BASS_ASIO_ChannelSetVolume)(BOOL input, int channel, float volume);
BASS_ASIO_ChannelSetVolume = func_type(ctypes.c_byte, ctypes.c_byte, ctypes.c_int, ctypes.c_float)(('BASS_ASIO_ChannelSetVolume', bassasio_module))
#float BASSASIODEF(BASS_ASIO_ChannelGetVolume)(BOOL input, int channel);
BASS_ASIO_ChannelGetVolume = func_type(ctypes.c_float, ctypes.c_byte, ctypes.c_int)(('BASS_ASIO_ChannelGetVolume', bassasio_module))
